...
:-build_in(current_functor/2,'gnu.prolog.vm.builtins.database.Predicates#CURRENT_FUNCTOR').
...
:-build_in(predicate_property/2,'gnu.prolog.vm.builtins.database.Predicates#PREDICATE_PROPERTY').
