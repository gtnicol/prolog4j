...
% sort(+List, -Sorted)
:-build_in(sort/2,'gnu.prolog.vm.builtins.list.Predicates#SORT').

% Equivalent to sort/2, but does not remove duplicates.
% msort(+List, -Sorted)
:-build_in(msort/2,'gnu.prolog.vm.builtins.list.Predicates#MSORT').
...
:-build_in(predsort/3,'gnu.prolog.vm.builtins.list.Predicates#PREDSORT').

% Reverse a list
% reverse(+List, ?Reversed)
:-build_in(reverse/2,'gnu.prolog.vm.builtins.list.Predicates#REVERSE').

% Get the Nth element of a list (1-indexed)
% nth(+Index, +List, ?Element)
:-build_in(nth/3,'gnu.prolog.vm.builtins.list.Predicates#NTH').

% Get the last element of a list
% last(?List, ?Element)
:-build_in(last/2,'gnu.prolog.vm.builtins.list.Predicates#LAST').
