...
:-build_in(dialog_file_save/1,'gnu.prolog.vm.builtins.dialogs.Predicates#FILE_SAVE').
:-build_in(dialog_file_save/2,'gnu.prolog.vm.builtins.dialogs.Predicates#FILE_SAVE').
...
:-build_in(dialog_file_open/1,'gnu.prolog.vm.builtins.dialogs.Predicates#FILE_OPEN').
:-build_in(dialog_file_open/2,'gnu.prolog.vm.builtins.dialogs.Predicates#FILE_OPEN').
...
:-build_in(dialog_prompt/1,'gnu.prolog.vm.builtins.dialogs.Predicates#PROMPT').
:-build_in(dialog_prompt/2,'gnu.prolog.vm.builtins.dialogs.Predicates#PROMPT').
...
:-build_in(dialog_confirm/1,'gnu.prolog.vm.builtins.dialogs.Predicates#CONFIRM').
:-build_in(dialog_confirm/2,'gnu.prolog.vm.builtins.dialogs.Predicates#CONFIRM').

% A simple message dialog
% dialog_message(+Options)
:-build_in(dialog_message/1,'gnu.prolog.vm.builtins.dialogs.Predicates#MESSAGE').
