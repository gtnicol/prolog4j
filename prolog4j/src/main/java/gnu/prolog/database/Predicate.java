...
public class Predicate
{
	...
	public static enum TYPE
	{
		...
		/**
		 * Check if this predicate type is defined (not UNDEFINED).
		 * @return true if this is not UNDEFINED
		 */
		...
		/**
		 * Check if this predicate type is built-in (CONTROL or BUILD_IN).
		 * @return true if this is CONTROL or BUILD_IN
		 */
		public boolean isBuiltIn() {
			return this == CONTROL || this == BUILD_IN;
		}

		/**
		 * Check if this predicate type is user-defined (USER_DEFINED or EXTERNAL).
		 * @return true if this is USER_DEFINED or EXTERNAL
		 */
		public boolean isUserDefined() {
			return this == USER_DEFINED || this == EXTERNAL;
		}
	}
	...
	protected List<Term> clauses = new CopyOnWriteArrayList<>();
	...
	/** standard library predicate flag - marks predicates from ISO/standard library */
	protected boolean standardLibraryFlag = false;
	 ...
	 *
	 * Returns a snapshot of the clauses at the time of calling. The returned list
	 * is safe to iterate without synchronization since it's backed by a
	 * CopyOnWriteArrayList which provides a snapshot iterator.
	 *
	 * @return an unmodifiable view of the clauses of the {@link Predicate}
	 * */
	...
	/**
	 * Check if predicate is from the standard library.
	 * ISO Prolog predicates from the standard library should have the built_in property.
	 *
	 * @return true if predicate is from standard library, false otherwise.
	 */
	public synchronized boolean isStandardLibrary()
	{
		return standardLibraryFlag;
	}

	/**
	 * Mark this predicate as part of the standard library.
	 * Standard library predicates are reported as built_in by predicate_property/2.
	 */
	public synchronized void setStandardLibrary()
	{
		standardLibraryFlag = true;
	}
	...
	public static Term prepareClause(Term clause) throws PrologException
	{
		...
		Term head;
		Term body;
		if (clause instanceof CompoundTerm ct)
		{
	...
	private static Term prepareBody(Term body, Term term) throws PrologException
	{
		...
		else if (body instanceof CompoundTerm ct)
		{
