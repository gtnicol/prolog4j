...
/** a prolog exception */
public final class PrologException extends Exception
{
	...
	public static void evaluationError(final AtomTerm error) throws PrologException
	{
		throw getError(new CompoundTerm(evaluationErrorTag, error));
	}

	/** @deprecated Use {@link #evaluationError(AtomTerm)} instead (corrected spelling) */
	@Deprecated
	public static void evalutationError(final AtomTerm error) throws PrologException
	{
