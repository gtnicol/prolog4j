 ...
 * call instruction.
 */
public final class IUnify extends Instruction
{
	/** a constructor */
	public IUnify()
	{}
	 ...
	 */
	@Override
	public EXRC execute(final ExecutionState state, final BacktrackInfo bi) throws PrologException
	{
		...
		return switch (rc)
		{
			case SUCCESS_LAST -> ExecutionState.EXRC.NEXT; /* proceed to next instruction */
			case FAIL -> ExecutionState.EXRC.BACKTRACK; /* backtrack */
			default -> ExecutionState.EXRC.BACKTRACK;
		};
	}
}
