 ...
 * the unknown flag.
 */
public class UndefinedPredicateCode implements ExecuteOnlyCode
{
	private static final Logger logger = LoggerFactory.getLogger(UndefinedPredicateCode.class);
			...
			throws PrologException
	{
		...
		{
			logger.warn("predicate {}/{} does not exist", predicateTag.functor.value, predicateTag.arity);
			return RC.FAIL;
		}
