...
public final class TermConstants
{
	...
	public static final AtomTerm formatAtom = AtomTerm.get("format");
	...
	public static final AtomTerm maxCharacterCodeAtom = AtomTerm.get("max_character_code");
	...
	public static final AtomTerm zeroDivisorAtom = AtomTerm.get("zero_divisor");
	/** @deprecated Use {@link #zeroDivisorAtom} instead (corrected spelling) */
	@Deprecated
	public static final AtomTerm zeroDivizorAtom = zeroDivisorAtom;
	...
	public static final AtomTerm daylightSavingAtom = AtomTerm.get("daylight_saving_time");
	...
	/** tag for DCG rules */
	public static final CompoundTermTag dcgRuleTag = CompoundTermTag.get("-->", 2);
