 ...
 * @version 0.0.1
 */
public final class IntegerTerm extends NumericTerm
{
	 ...
	 */
	public static IntegerTerm get(final int val)
	{
	 ...
	 */
	public static IntegerTerm get(final String str)
	{
	 ...
	 */
	public IntegerTerm(final String str)
	{
		this(parseInt(str));
	}
	 ...
	 *          value of term
	 */
	public IntegerTerm(final int val)
	{
		value = val;
	}
	...
	{
		return obj instanceof IntegerTerm that && that.value == value;
	}
