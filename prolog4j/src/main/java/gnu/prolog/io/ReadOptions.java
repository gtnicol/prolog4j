...
public class ReadOptions extends AbstractOptions
{
	...
	public final List<Term> variables = new ArrayList<>();
	/** 'variable_names' ISO Prolog options */
	public final Map<String, VariableTerm> variableNames = new HashMap<>();
	/**
	 * 'singletons' ISO Prolog options it is not used currently.
	 */
	public final Map<String, VariableTerm> singletons = new HashMap<>();
}
