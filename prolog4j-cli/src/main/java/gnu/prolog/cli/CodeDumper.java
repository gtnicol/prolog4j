...
{
	private static final Logger logger = LoggerFactory.getLogger(CodeDumper.class);
	...
	public static void main(String args[])
	{
		try
		{
			...
			if (args.length < 2)
			{
				System.out.println("usage: java gnu.prolog.cli.CodeDumper <text to load> <predicate indicator>");
				System.out.println("example: java gnu.prolog.cli.CodeDumper append.pro append/3");
			}
		...
		{
			logger.error("Error dumping code", ex);
		}
	}
}
